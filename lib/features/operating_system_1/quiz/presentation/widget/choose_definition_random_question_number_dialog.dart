...
class ChooseDefinitionRandomQuestionNumberDialog extends StatelessWidget {
  ChooseDefinitionRandomQuestionNumberDialog({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getIt<QuizFeatureBloc>()..add(DefinitionsRandomQuizEvent()),
      child: BlocSelector<QuizFeatureBloc, QuizFeatureState,
          BlocStateData<DefinitionsRandomQuizModel>>(
        selector: (state) => state.definitionsRandomQuizState,
