...
class StudyDataSource {
  ...
  Future<ImportantQuestionModel> importantQuestion() async {
    final String response =
        await rootBundle.loadString(Assets.jsonImportantQuestion);
    final data = json.decode(response);
    final model = ImportantQuestionModel.fromJson(data);
    return model;
  }
}
