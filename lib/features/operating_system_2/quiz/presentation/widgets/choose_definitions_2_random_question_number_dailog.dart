...
import '../../../../operating_system_1/quiz/presentation/pages/identification_quiz_screen.dart';

class ChooseDefinitions2RandomQuestionNumberDialog extends StatelessWidget {
  ChooseDefinitions2RandomQuestionNumberDialog({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getIt<QuizOperatingSystem2Bloc>()..add(DefinitionRandom2QuizEvent()),
      child: BlocSelector<QuizOperatingSystem2Bloc, QuizOperatingSystem2State,
          BlocStateData<DefinitionsRandomQuizModel>>(
        selector: (state) => state.definitionsRandom2QuizState,
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    if (requestedQuestions > 0 &&
                      ...
                      List<Definition> shuffledQuestions =
                      List<Definition>.from(state.randomQuiz);
                      shuffledQuestions.shuffle();
                      List<Definition> selectedQuestions =
