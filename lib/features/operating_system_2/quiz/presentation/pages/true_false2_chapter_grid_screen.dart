...
class TrueFalse2ChapterGridScreen extends StatelessWidget {
  final String isStudy;
  static const String name = 'true_false2_chapter_grid_screen';
  static const String path = '/true_false2_chapter_grid_screen';

  const TrueFalse2ChapterGridScreen({super.key, required this.isStudy});
        ...
        body: SafeArea(
          child: SectionWidget(
            widget: BlocSelector<QuizOperatingSystem2Bloc,
              ...
              selector: (state) => state.trueFalse2QuizState,
