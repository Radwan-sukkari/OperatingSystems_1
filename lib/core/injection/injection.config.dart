...
import '../../features/quiz/domain/use_case/quiz_use_case.dart' as _i883;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i883.QuizUseCase>(
        () => _i883.QuizUseCase(quizRepo: gh<_i1039.QuizRepo>()));
    gh.factory<_i975.QuizFeatureBloc>(
        () => _i975.QuizFeatureBloc(gh<_i883.QuizUseCase>()));
    return this;
  }
}
